    ...
    public MqttClient publishConnect() {
        ...
        try {
            if (publishClient==null) {
                ...
                //publishClient = new MqttClient("tcp://192.168.1.206:18083", "mqtt_publish", new MemoryPersistence());
                //发布消息不需要回调连接
    ...
    public void subsribeConnect() {
        try {
            ...
            if (subsribeClient==null) {
                ...
                //subsribeClient = new MqttClient("tcp://192.168.1.206:18083", "mqtt_publish", new MemoryPersistence());// MemoryPersistence设置clientid的保存形式，默认为以内存保存
